    ...
    <nav className="bg-customBg text-black p-4">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          <Link to="/login" className="px-4 py-2 rounded hover:bg-gray-200 transition">Connexion</Link>
...
//         {/* <Link to="/" className="text-lg font-bold hidden md:block">Accueil</Link> */}
//         <div className="hidden md:flex items-center space-x-4">
//           <Link to="/dashboard" className="px-4 py-2 rounded hover:bg-gray-200 transition">📚 Devoir</Link>
//           <Link to="/login" className="px-4 py-2 rounded hover:bg-gray-200 transition">Connexion</Link>
//           <Link to="/signup" className="px-4 py-2 rounded hover:bg-gray-200 transition">Inscription</Link>
//           <Link to="/communications" className="px-4 py-2 rounded hover:bg-gray-200 transition">📢 Communications</Link>
//           <button onClick={handleLogout} className="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-700 transition">Déconnexion</button>
//         </div>
//         <div className="md:hidden flex items-center justify-between w-full">
//           <Link to="/" className="text-lg font-bold">
...
//       {isOpen && (
//         <div className="md:hidden mt-4 flex flex-col items-center space-y-2">
//           <Link to="/dashboard" className="block px-4 py-2 rounded hover:bg-gray-200 transition">📚 Devoir</Link>
//           <Link to="/communications" className="block px-4 py-2 rounded hover:bg-gray-200 transition">📢 Communications</Link>
//           <Link to="/login" className="block px-4 py-2 rounded hover:bg-gray-200 transition">Connexion</Link>
//           <Link to="/signup" className="block px-4 py-2 rounded hover:bg-gray-200 transition">Inscription</Link>
//         </div>
//       )}
